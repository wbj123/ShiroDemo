...
import com.example.demo.quartz.utils.QuartzManager;
import com.example.demo.service.JobService;
import com.example.demo.utils.ScheduleJobUtils;
import com.example.demo.vo.ScheduleJob;
...
public class JobServiceImpl implements JobService {
	...
	public void initSchedule() throws SchedulerException {
		...
		reqMap.put("jobGroup","hospital_synchronization");
		List<TaskDO> jobList = taskScheduleJobMapper.list(reqMap);
